        ...
        while (true) {
            ...
            switch ((int) opcio) {
                case 1:
                    ...
                    if (num1 == 0.5 || num1 == 1.5 || num1 == 2.5 || num1 == 2.5 || num1 == 3.5 || num1 == 4.5 || num1 == 5.5 || num1 == 6.5 || num1 == 7.5 || num1 == 8.5 || num1 == 9.5) {
...
//               }
                ...
                case 6:
                    ...
                    break;
                case 7:
                    System.out.println("Hem dic " + nombre + " i  soc un Alien " + tipus + ".  El meu solc  desplacant com " + vitage + " el meu número preferit es" + favorit + ".");
                    break;
                default:
                return true;
            }
