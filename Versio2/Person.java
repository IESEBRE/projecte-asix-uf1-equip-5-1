        ...
        while (true) {
            ...
            switch (pregunta) {
                case 1:// 1
                    ...
                    while (num > 100 || num<1){ if (num > 100 || num<1) {System.out.println("Valor incorrecte. Torna-ho a provar."); num = Integer.parseInt(entrada.nextLine());}else  break;}
                    if (num % 2 == 0 && num % 3 == 0) {
                ...
                case 2://2
                    if (ordre[0] && ordre[1]==false) {
                        ...
                        while (esport > 10 || esport<1){ if (esport > 10 || esport<1) {System.out.println("Valor incorrecte. Torna-ho a provar."); esport = Integer.parseInt(entrada.nextLine());}else  break;}
                        if (esport == 1) {
                ...
                case 3://3
                    if (ordre[1] && ordre[2]==false) {
                        ...
                        while (num2>0){ if (num2>0) {System.out.println("Valor incorrecte. Torna-ho a provar."); num2 = Integer.parseInt(entrada.nextLine());}else  break;}
