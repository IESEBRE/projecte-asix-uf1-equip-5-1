...
public class Alien {
    ...
    String talking() {
        ...
        while (true) {
            ...
            pregunta = Float.parseFloat(entrada.nextLine());
            while (pregunta > 8 || pregunta<0){ if (pregunta > 8 || pregunta<0) {System.out.println("Valor incorrecte. Torna-ho a provar."); pregunta = Float.parseFloat(entrada.nextLine());}else  break;}
            switch ((int)pregunta ) {
                case 1:
                    ...
                    while (num1 > 10.0 || num1 <0.0){ if (num1 > 10.0 || num1 <0.0) {System.out.println("Valor incorrecte. Torna-ho a provar."); num1 = Float.parseFloat(entrada.nextLine());}else  break;}
                ...
                case 2:
                    if (ordre[0] && ordre[1] == false) {
                        ...
                        num1 = Float.parseFloat(entrada.nextLine());;
                        while (num1 > 1.0 || num1 <0.1){ if (num1 > 1 || num1 <0.1) {System.out.println("Valor incorrecte. Torna-ho a provar."); num1 = Float.parseFloat(entrada.nextLine());}else  break;}
                        if (num1 == (float) 0.1) {
                ...
                case 3:
                    if (ordre[1] && ordre[2] == false) {
                        ...
                        while (num2>0.0){ if (num2>0.0) {System.out.println("Valor incorrecte. Torna-ho a provar."); num2 = Float.parseFloat(entrada.nextLine());}else  break;}
                ...
                case 6:
                    if (ordre[4] && ordre[5] == false) {
                        ...
                        while (nom.trim().length()==0){ if (nom.trim().length()==0) {System.out.println("Valor incorrecte. Torna-ho a provar."); nom = entrada.nextLine();}else  break;}
