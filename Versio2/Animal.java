...
public class Animal {
    ...
    String talking() {
        ...
        while (true) {
            ...
            while (pregunta > 8 || pregunta<0){ if (pregunta > 8 || pregunta<0) {System.out.println("Valor incorrecte. Torna-ho a provar."); pregunta = Integer.parseInt(entrada.nextLine());}else  break;}
            switch (pregunta) {
                case 1:
                    if (mostrar) System.out.println("Defineix quin tipus d'animal ets:");
                    char animal = entrada.next().charAt(0);
                    while (animal<'A'|| animal>'Z'){ if (animal<'A'|| animal>'Z') {System.out.println("Valor incorrecte. Torna-ho a provar."); animal = entrada.next().charAt(0);}else  break;}
                    int difG = 'G' - animal;
                    int difS = 'S' - animal;
                ...
                case 2:
                    if (ordre[0] && ordre[1] == false) {
                        ...
                        while (VLetra<'A'|| VLetra>'J'){ if (VLetra<'A'|| VLetra>'J') {System.out.println("Valor incorrecte. Torna-ho a provar."); VLetra = entrada.next().charAt(0);}else  break;}
                        if (VLetra==('A')) {
                ...
                case 3:
                    if (ordre[1] && ordre[2] == false) {
                        ...
                        while (Caracter<'A'|| Caracter>'Z'){ if (Caracter<'A'|| Caracter>'Z') {System.out.println("Valor incorrecte. Torna-ho a provar."); Caracter = entrada.next().charAt(0);}else  break;}
                ...
                case 6:
                    if (ordre[4] && ordre[5] == false) {
                        ...
                        nomguardar = entrada.nextLine();
                        while (nomguardar.trim().length()==0){ if (nomguardar.trim().length()==0) {System.out.println("Valor incorrecte. Torna-ho a provar."); nomguardar = entrada.nextLine();}else  break;}
